...
maxA = maxAcross(rows)
maxV = maxVert(rows)
maxDB = maxDiagonalBackward(rows)
maxDF = maxDiagonalForward(rows)

print "Across: ", maxA
print "Vertical: ", maxV
print "DiagonalBackward: ", maxDB
print "DiagonalForward: ", maxDF
...
print "max: ", max([maxA, maxV, maxDB, maxDF])
